  ...
  const NAV_REGISTRY: NavGroup[] = [
    {
      ...
      categories: [
        {
          id: "admin.insights",
          label: t("admin.navCat.insights", "인사이트"),
          items: [
            { key: "admin.dashboard", label: t("nav.dashboard", "대시보드") },
        ...
        {
          id: "admin.members",
          label: t("admin.navCat.members", "회원·조직"),
          items: [
        ...
        {
          id: "admin.contents",
          label: t("admin.navCat.contents", "콘텐츠"),
          items: [
            ...
            { key: "admin.aiQuestionGen", label: t("nav.aiQuestionGen", "AI 문제 생성") },
            { key: "admin.englishCorrection", label: t("nav.englishCorrection", "AI 영어 교정") },
          ],
        },
        {
          id: "admin.operations",
          label: t("admin.navCat.operations", "학습 운영"),
          items: [
        ...
        },
        {
          ...
          label: t("admin.navCat.communications", "커뮤니케이션"),
          items: [
      ...
      categories: [
        {
          ...
          items: [
            ...
            { key: "teacher.courses", label: t("nav.courseManagement", "강의 관리") },
