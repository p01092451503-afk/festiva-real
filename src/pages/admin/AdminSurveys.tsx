        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
            <h1 className="text-xl sm:text-2xl font-semibold text-foreground flex items-center gap-2">
              <ClipboardList className="h-5 w-5 sm:h-6 sm:w-6" aria-hidden="true" /> {t("adminSurveys.title")}
            </h1>
            <p className="text-xs sm:text-sm text-muted-foreground mt-1">{t("adminSurveys.subtitle")}</p>
          </div>
              ...
              {resultsDialog && (
                <Button
                  ...
                  onClick={() => {
                    ...
                    lines.push("───────────────────────────────────────");
                    lines.push("WEBHEADS SaaS LMS | 자동 생성 리포트");
