...
const HomeCourseFeatureSection = ({ courses = [] }: { courses?: CourseLite[] }) => {
  ...
  return (
    <section className="bg-navy text-primary-foreground border-y border-navy-dark">
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-4">
          {FEATURES.map(({ icon: Icon, label, desc }) => (
            <div key={label} className="rounded-xl border border-primary-foreground/15 bg-primary-foreground/5 p-5">
