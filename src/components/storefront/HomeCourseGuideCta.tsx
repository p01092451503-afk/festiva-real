  ...
  <section className="bg-slate-50 border-y border-border/60">
    <div className="max-w-6xl mx-auto px-4 py-10 sm:py-12">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5 rounded-2xl bg-white border border-border p-6 sm:p-8 shadow-sm">
        ...
        <Link
          to="/store/courses"
          className="inline-flex items-center justify-center gap-2 rounded-lg bg-navy px-6 py-3 text-sm sm:text-base font-semibold text-white transition-opacity hover:opacity-90 shrink-0"
        >
          강의 안내 보기
