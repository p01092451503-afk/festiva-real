          ...
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={hourlyData} margin={isMobile ? { top: 4, right: 4, left: 0, bottom: 0 } : { top: 4, right: 8, left: 0, bottom: 0 }}>
              ...
              <Tooltip
                ...
                formatter={(value: number) => [t("stats.accessCount", { count: value }), t("stats.accessLabel")]}
              />
              <Bar dataKey="count" name={t("stats.accessLabel")} fill="hsl(217 91% 60%)" radius={[3, 3, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </CardContent>
