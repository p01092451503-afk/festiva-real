        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_1fr] gap-12 lg:gap-16">
          ...
          <div className="min-w-0 lg:justify-self-end w-full lg:w-auto">
            <div className="rounded-xl border border-border bg-background/70 p-6 lg:min-w-[280px]">
              ...
              {s?.company_phone && (
                <a href={`tel:${s.company_phone.replace(/[^0-9+]/g, "")}`} className="mt-5 flex items-center justify-center gap-2 rounded-full bg-primary px-4 py-2.5 text-sm font-semibold text-primary-foreground hover:opacity-90 transition-opacity">
